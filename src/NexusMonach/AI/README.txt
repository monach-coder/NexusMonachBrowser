...
исходную речь без перевода, после чего OPUS-MT создаёт русскую строку субтитров.
Оба процесса остаются запущенными между репликами и не загружают веса заново.
