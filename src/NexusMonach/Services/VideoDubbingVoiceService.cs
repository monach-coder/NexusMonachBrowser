...
public static class VideoDubbingVoiceService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var item = new DubbingVoiceItem(safe, Math.Clamp(rate, -4, 4),
            ...
            Volatile.Read(ref _stopGeneration), Cancel: false);
    ...
    public static void Stop()
    {
        ...
        Queue.TryAdd(new DubbingVoiceItem(string.Empty, 0,
            ...
            Volatile.Read(ref _stopGeneration), Cancel: true));
    }
        ...
        try
        {
            foreach (var item in Queue.GetConsumingEnumerable())
            {
                ...
                try
                {
                    ...
                    if (NeuralVoiceService.TrySpeak(item.Text, item.Profile, item.Rate,
                    ...
                    var retried = NeuralVoiceService.TrySpeak(item.Text, item.Profile, item.Rate,
                        NeuralVoiceLane.Dubbing);
