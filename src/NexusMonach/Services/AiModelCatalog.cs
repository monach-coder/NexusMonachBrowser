...
public static class AiModelCatalog
{
    ...
    // Приоритет: base — обязательный для живого дубляжа (0.4× realtime,
    // перевод успевает за видео); small — только для трек-режима (1.2×
    // realtime — живой режим отстаёт, пользователь подтвердил);
    // large-v3-turbo — опционально для мощных машин/GPU.
