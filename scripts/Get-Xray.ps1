# Воспроизводимая загрузка транспорта VLESS (Xray-core, MPL-2.0) в дерево
# проекта. Бинари не хранятся в git — этот скрипт приводит рабочую копию
# в состояние, из которого Build-Portable собирает nexus-net-xray.zip.
#
